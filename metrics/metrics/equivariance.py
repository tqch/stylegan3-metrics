...
def compute_equivariance_metrics(opts, num_samples, batch_size, translate_max=0.125, rotate_max=1,
                                 compute_eqt_int=False, compute_eqt_frac=False, compute_eqr=False):
